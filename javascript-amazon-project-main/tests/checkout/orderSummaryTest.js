...
describe('test suite: renderOrderSummary', () => {
    ...
    beforeEach(() => {
        ...
        document.querySelector('.js-test-container').innerHTML = `
            ...
            <div class="checkout-header-middle-section js-checkout-quantity"></div>
        `;
    ...
    it('removes a product', () => { 
        ...
        expect(carts.cartsItems[1].productId).toEqual(productId2);
    });

    it('updates the delivery option', () => {
        document.querySelector(`.js-delivery-option-${productId2}-3`).click();

        expect(document.querySelector(`.js-delivery-option-input-${productId2}-3`).checked).toEqual(true);
        expect(carts.cartsItems.length).toEqual(2);
        expect(carts.cartsItems[1].productId).toEqual(productId2);
        expect(carts.cartsItems[1].deliveryOptionId).toEqual('2');
        expect(document.querySelector('.js-payment-summary-shipping').innerText).toEqual('$4.99');
        expect(document.querySelector('.js-payment-summary-total').innerText).toEqual('$40.52');
    });
